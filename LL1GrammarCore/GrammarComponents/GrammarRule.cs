...
namespace LL1GrammarCore.GrammarComponents
{
    ...
    /// </summary>
    internal class GrammarRule : IGrammarRule
    {
        /// <summary>
        /// Левая часть правила.
        /// </summary>
        ...
        /// </summary>
        public List<IGrammarRulePart> Right { get; set; } = new List<IGrammarRulePart>();
        ...
        public GrammarRule(string line, ISpecialSymbols specialSymbols)
        {
            if (line == null || line == "")
        ...
        /// <param name="specialSymbols">Специальные символы грамматики.</param>
        public void BuildRightPart(IEnumerable<IGrammarRule> rules, ISpecialSymbols specialSymbols)
        {
        ...
        private void SetResult(ref IGrammarRulePart result, IGrammarRulePart rulePart)
        {
            if (result != null)
        ...
        public IGrammarRulePart GetNext(string remainingData)
        {
            IGrammarRulePart result = null;
            IGrammarRulePart empty = null;
