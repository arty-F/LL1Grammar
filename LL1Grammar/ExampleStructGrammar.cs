    ...
    public class ExampleStructGrammar
    {
        ...
        public ExampleStructGrammar()
        {
            grammar = "StartStruct->~Title~Body~" + Environment.NewLine +
                      ...
                      "StructName->a-z<A1>NxtName~<A4><A2>|A-Z<A1>NxtName~<A4><A2>|0-9<A1>NxtName~<A4><A2>|_<A1>NxtName~<A4><A2>|@<A1>NxtName~<A4><A2>" + Environment.NewLine +
                      "NxtName->a-z<A1>NxtName|A-Z<A1>NxtName|0-9<A1>NxtName|_<A1>NxtName|$" + Environment.NewLine +
                      "Body->{~Elements~}<A0>~SplitterStruct" + Environment.NewLine +
                      ...
                      "FName->a-z<A1>NxtName|A-Z<A1>NxtName|0-9<A1>NxtName|_<A1>NxtName|@<A1>NxtName";
            ...
            data = "public struct exStruct" + Environment.NewLine +
                   ...
                   "\t\tSystem.UInt64? innerField2;" + Environment.NewLine +
